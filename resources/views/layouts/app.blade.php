                ...
                @if(Auth::check())
                    <div class="col-lg-4">
                        <ul class="list-group">
                            ...
                            @if(Auth::user()->admin)
                                <li class="list-group-item">
                                    <a href="{{ route('users') }}">Utilisateur</a>
                                </li>
                                ...
                                <li class="list-group-item">
                                    <a href="{{ route('tag.create') }}">Créer un tags</a>
                                </li>
                                ...
                                <li class="list-group-item">
                                    <a href="{{ route('post.create') }}">Ecrire un article</a>
                                </li>
                                ...
                                <li class="list-group-item">
                                    <a href="{{ route('posts.trashed') }}">Corbeille</a>
                                </li>
